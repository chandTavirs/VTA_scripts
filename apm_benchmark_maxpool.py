...
maxPoolConfigs = [
    ...
    # ("Config_2", maxPoolConfig(3, 3, 1, 1, 1, 1, 0)),
...
def run_maxpool(env, remote, wl, target, log_file='logs/log.json', host_ip = '192.168.2.99'):
    ...
    for cfg_name, cfg in maxPoolConfigs:
        print(cfg)
        ...
        vta_exec_maxpool = nn.MaxPool2d(kernel_size=(cfg.hkernel, cfg.wkernel), padding=(cfg.hpad, cfg.wpad),
                                        stride=(cfg.hstride, cfg.wstride), ceil_mode=bool(cfg.ceil_mode))
        ...
        workload_dict["results"]["({},{},{},{},{},{},{})".format(cfg.hkernel, cfg.wkernel, cfg.hpad,
                                                                 cfg.wpad, cfg.hstride, cfg.wstride,
                                                                 cfg.ceil_mode)] = result_dict
